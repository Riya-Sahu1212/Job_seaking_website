...
const MyJobs = () => {
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`https://job-seaking-website-tyb7.vercel.app/api/v1/job/update/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(`https://job-seaking-website-tyb7.vercel.app/api/v1/job/delete/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
